...
{
    public class ChildFacadeTests : TestUtils
    {
        public ChildFacadeTests(ITestOutputHelper output) : base(output)
        {
        }
        ...
        public void CreateNew_WhenCalled_ThrowsDuplicateException()
        {
            ...
            mockDuplicateControlResolver.Setup(d => d("Child")).Returns(mockDuplicateControl.Object);
            var mockPersonVerifier = Mock.Of<IPersonVerification>();
            IChildFacade sut = new ChildFacadeImpl(mockDataService, mockDuplicateControlResolver.Object, mockPersonVerifier);
        ...
        public void CreateNew_WhenCalled_ThrowsPersonVerificationException()
        {
            ...
            IChildFacade sut = new ChildFacadeImpl(mockDataService, mockDuplicateControlResolver, personVerifier);
        ...
        public void CreateNew_WhenCalled_Returns_Data()
        {
            ...
            mockDuplicateControlResolver.Setup(d => d("Child")).Returns(mockDuplicateControl);
            var mockPersonVerifier = Mock.Of<IPersonVerification>();
            IChildFacade sut = new ChildFacadeImpl(mockDataService.Object, mockDuplicateControlResolver.Object, mockPersonVerifier);
