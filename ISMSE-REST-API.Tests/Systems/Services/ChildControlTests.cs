...
{
    public class ChildControlTests : TestUtils
    {
        public ChildControlTests(ITestOutputHelper output) : base(output)
        {
        }
        ...
        public void VerifyExisting_WhenCalled_Returns_OK_Empty()
        {
            ...
            IDuplicateControl sut = new ChildControl(mockCissaDAL.Object);
            //Act
